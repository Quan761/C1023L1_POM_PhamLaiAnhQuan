...
public class AbstractPage {
	...
	public void dragAndDropElement(WebDriver driver, String locator, String destination){
		WebElement elementSource = findAnElement(driver, locator);
	...
	public Object scrollToElement(WebDriver driver, String locator){
		WebElement element = findAnElement(driver, locator);
		return ((JavascriptExecutor) driver).executeScript("argument[0].scrollToView(true);",element);
	}
